...
var __gwtModuleFunction = $wnd.org_dashbuilder_DashbuilderRuntime;
...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.org.dashbuilder.DashbuilderRuntime=");
    idx += (13 + "org.dashbuilder.DashbuilderRuntime".length);  // 
  }
  if (idx >= 0) {
...
//# sourceURL=org.dashbuilder.DashbuilderRuntime-0.js
